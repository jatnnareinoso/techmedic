        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-4 text-gray-800">Menú de Opciones</h1>
                    ...
                    <div class="row">
                            ...
                            <a href="pacientes.php" class="text-decoration-none">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Visualiza y gestiona la información de tus pacientes.</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-lg-4 mb-4">
                            <a href="citas.php" class="text-decoration-none">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            <i class="fa-solid fa-hospital-user"></i> Citas
                                        </h5>
                                        <p class="card-text">Consulta y gestiona las citas con tus pacientes.</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-lg-4 mb-4">
                            <a href="historial_clinico.php" class="text-decoration-none">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            <i class="fa-solid fa-stethoscope"></i> Historial Clínico
                                        </h5>
                                        <p class="card-text">Accede al historial médico completo de tus pacientes.</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-lg-4 mb-4">
                            <a href="mensajeria.php" class="text-decoration-none">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            <i class="fa-regular fa-envelope"></i> Mensajería
                                        </h5>
                                        <p class="card-text">Comunícate con tus pacientes y revisa mensajes importantes.</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a href="calendar.php" class="text-decoration-none">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Consulta y gestiona las citas a través del calendario.</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-lg-4 mb-4">
                            <a href="configuracion_doctor.php" class="text-decoration-none">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            <i class="fa-solid fa-cogs"></i> Configuración
                                        </h5>
                                        <p class="card-text">Ajusta las configuraciones de tu cuenta y perfil.</p>
                                    </div>
                                </div>
                            </a>
                        </div>
