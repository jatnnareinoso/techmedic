...
if (isset($_SESSION['correo_paciente'])) {
    ...
    if ($resultPaciente) {
        ...
        $sqlConsultas = "SELECT c.*, d.nombre AS nombre_doctor, d.apellido AS apellido_doctor 
                     FROM consulta c 
    ...
    if ($resultConsultas) {
        ...
        echo "Error al obtener las consultas: " . ($errorInfo ? $errorInfo[2] : "No se pudo obtener información del error");
    }
} else {
    $errorInfo = isset($conn) ? $conn->errorInfo() : null;
