    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 mb-4">
                    <a href="consultas.php" class="text-decoration-none">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">
                                    <i class="fa-solid fa-hospital-user"></i> Consultas
                                </h5>
                                <p class="card-text">Consulta las diversas citas que has tenido.</p>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-lg-4 mb-4">
                    <a href="historia_clinico.php" class="text-decoration-none">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">
                                    <i class="fa-solid fa-stethoscope"></i> Historial Clínico
                                </h5>
                                <p class="card-text">Accede a tu historial médico completo.</p>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-lg-4 mb-4">
                    <a href="mensajeria_paciente.php" class="text-decoration-none">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">
                                    <i class="fa-regular fa-envelope"></i> Mensajería
                                </h5>
                                <p class="card-text">Comunícate con tus doctores y revisa mensajes importantes.</p>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 mb-4">
                    <a href="calendar_paciente.php" class="text-decoration-none">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">
                ...
                <div class="col-lg-4 mb-4">
                    <a href="configuracion_paciente.php" class="text-decoration-none">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">
