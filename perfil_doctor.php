...
if (isset($_SESSION['correo_doctor'])) {
    ...
    if ($result) {
        ...
        if ($resultEspecialidad) {
            $rowEspecialidad = $resultEspecialidad->fetch(PDO::FETCH_ASSOC);
            $nombreEspecialidad = $rowEspecialidad['especialidad'];
        } else {
            $nombreEspecialidad = "No disponible";
        }
    } else {
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">Perfil del Doctor</h1>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Información del Doctor</h6>
                                </div>
                                <div class="card-body text-center">
                                    <img src="img/undraw_doctor.svg" alt="Doctor Image" class="doctor-image img-fluid">
                                    <h2 class="mt-4 mb-2"><?php echo $doctor['nombre'] . ' ' . $doctor['apellido']; ?></h2>
                                    <p><strong>Especialidad:</strong> <?php echo $nombreEspecialidad; ?></p>
                                    <p><strong>Experiencia:</strong> <?php echo $doctor['experiencia']; ?></p>
                                    <p><strong>Correo Electrónico:</strong> <?php echo $doctor['correo']; ?></p>
                                    <p><strong>Teléfono:</strong> <?php echo $doctor['telefono']; ?></p>
                                    <p><strong>Cédula:</strong> <?php echo $doctor['cedula']; ?></p>
                                    <p><strong>Lugar de Trabajo:</strong> <?php echo $doctor['lugar_trabajo']; ?></p>
                                    <p><strong>Seguro:</strong> <?php echo $doctor['seguro']; ?></p>
                                    <p><strong>Estudio Secundario:</strong> <?php echo $doctor['estudio_sec']; ?></p>
                                    <p><strong>Universidad:</strong> <?php echo $doctor['universidad']; ?></p>
                                    <p><strong>Especialidad Universitaria:</strong> <?php echo $doctor['especialidad_uni']; ?></p>
                                    <p><strong>Título:</strong> <?php echo $doctor['titulo']; ?></p>
                                    <p><strong>Curso:</strong> <?php echo $doctor['curso']; ?></p>
                                    <p><strong>Nacionalidad:</strong> <?php echo $doctor['nacionalidad']; ?></p>
                                    <p><strong>Provincia:</strong> <?php echo $doctor['provincia']; ?></p>
                                    <p><strong>Ciudad:</strong> <?php echo $doctor['ciudad']; ?></p>
                                    <p><strong>Dirección:</strong> <?php echo $doctor['direccion']; ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
